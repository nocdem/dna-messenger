...
**Versions:** Library v0.3.113 | Flutter v0.99.62 | Nodus v0.4.3
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.3.113 | C code changes (src/, dht/, messenger/, p2p/, crypto/, include/) |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v0.99.62+9962 | Flutter/Dart code changes (lib/, assets/) |
