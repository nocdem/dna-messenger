...
- [x] Double free crash on DHT events - stack-allocated events became garbage when async Dart callback accessed them, fixed with heap allocation + dna_free_event (v0.3.38)
