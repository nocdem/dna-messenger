...
**Versions:** Library v0.6.36 | Flutter v0.100.54 | Nodus v0.4.5
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.6.37 | C code changes (src/, dht/, messenger/, transport/, crypto/, include/) |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v0.100.54+10154 | Flutter/Dart code changes (lib/, assets/) |
