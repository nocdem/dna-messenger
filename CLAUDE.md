...
**Versions:** App v0.2.90 (`include/dna/version.h`) | Nodus v0.4.3 (`vendor/opendht-pq/tools/nodus_version.h`)
...
|-----------|--------------|---------|
| App (CLI + C lib) | `include/dna/version.h` | v0.2.90 |
| Flutter/Android | `dna_messenger_flutter/pubspec.yaml` | v0.2.90+290 |
