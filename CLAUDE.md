...
**Last Updated:** 2026-01-29 | **Status:** BETA | **Phase:** 7 (Flutter UI)

**Versions:** Library v0.6.74 | Flutter v0.100.67 | Nodus v0.4.5
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.6.64 | C code changes (src/, dht/, messenger/, transport/, crypto/, include/) |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v0.100.65+10165 | Flutter/Dart code changes (lib/, assets/) |
