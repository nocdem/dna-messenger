...
**Versions:** Library v0.3.112 | Flutter v0.99.61 | Nodus v0.4.3
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.3.112 | C code changes (src/, dht/, messenger/, p2p/, crypto/, include/) |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v0.99.61+9961 | Flutter/Dart code changes (lib/, assets/) |
