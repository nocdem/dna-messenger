...
namespace DNATheme {
    ...
    inline ImVec4 TextWarning() { return ImVec4(1.0f, 0.3f, 0.3f, 1.0f); }      // #FF4D4D - Red warning
    inline ImVec4 TextSuccess() { return ImVec4(0.3f, 1.0f, 0.3f, 1.0f); }      // #4DFF4D - Green success
