...
**Versions:** Library v0.6.47 | Flutter v0.100.56 | Nodus v0.4.5
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.6.47 | C code changes (src/, dht/, messenger/, transport/, crypto/, include/) |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v0.100.56+10156 | Flutter/Dart code changes (lib/, assets/) |
