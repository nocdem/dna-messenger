...
**Versions:** Library v0.6.50 | Flutter v0.100.58 | Nodus v0.4.5
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.6.50 | C code changes (src/, dht/, messenger/, transport/, crypto/, include/) |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v0.100.58+10158 | Flutter/Dart code changes (lib/, assets/) |
