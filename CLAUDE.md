...
**Last Updated:** 2026-01-11 | **Status:** BETA | **Phase:** 7 (Flutter UI)

**Versions:** Library v0.4.34 | Flutter v0.99.117 | Nodus v0.4.4
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.4.34 | C code changes (src/, dht/, messenger/, p2p/, crypto/, include/) |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v0.99.101+10001 | Flutter/Dart code changes (lib/, assets/) |
| Nodus Server | `vendor/opendht-pq/tools/nodus_version.h` | v0.4.4 | Nodus server changes (vendor/opendht-pq/tools/) |
