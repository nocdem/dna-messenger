...
**Versions:** Library v0.6.81 | Flutter v0.100.68 | Nodus v0.4.5
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.6.80 | C code changes (src/, dht/, messenger/, transport/, crypto/, include/) |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v0.100.68+10168 | Flutter/Dart code changes (lib/, assets/) |
