...
int main() {
    printf("Test 1: Create profile...\n");
    dna_profile_data_t *profile = dna_profile_create();
    assert(profile != NULL);
    printf("  OK\n");

    printf("Test 2: Free profile...\n");
    dna_profile_free(profile);
    printf("  OK\n");

    printf("Test 3: Create identity...\n");
    dna_unified_identity_t *identity = dna_identity_create();
    assert(identity != NULL);
    printf("  OK\n");

    printf("Test 4: Free identity...\n");
    dna_identity_free(identity);
    printf("  OK\n");

    printf("Test 5: Validate name...\n");
    int result = dna_validate_name("nocdem");
    printf("  Result: %d\n", result);

    printf("Test 6: Validate wallet...\n");
